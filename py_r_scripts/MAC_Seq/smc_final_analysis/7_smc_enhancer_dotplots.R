...
enhancer_effectsize <- read.csv(paste0(save_path_snps,"/smc_enhancer_mean_effects.csv"))
...
ggsave(filename= file.path(export_fig2, "smc_enhancer_dotplot.svg"), 
...
ggsave(filename= file.path(export_fig2, "smc_enhancer_dotplot_downreg.svg"), 
       plot=enhancer_effect_plot, width = 14, height = 4.2)
...
ggsave(filename= file.path(export_fig2, "smc_enhancer_dotplot_upreg.svg"), 
       plot=enhancer_effect_plot, width = 14, height = 4.2)
...
#enhancer_effectsize$Gene <- factor(enhancer_effectsize$Gene, levels = c("CDKN2B","MTAP","CDKN2A","CDKN2B-AS1","DMRTA1"),
#                                   ordered = TRUE)
...
ggsave(filename= file.path(export_fig2, "smc_mir31hg_enhancer_dotplot.svg"), 
       plot=enhancer_effect_plot, width = 14, height = 4.2)
...
ggsave(filename= file.path(export_fig2, "smc_mir31hg_enhancer_dotplot_downreg.svg"), 
       plot=enhancer_effect_plot, width = 14, height = 4.2)
...
ggsave(filename= file.path(export_fig2, "smc_mir31hg_enhancer_dotplot_upreg.svg"), 
       plot=enhancer_effect_plot, width = 14, height = 4.2)