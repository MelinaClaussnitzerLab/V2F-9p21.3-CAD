...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/qc_plots"
...
genecounts1 <- as.matrix(dxl01_1_smc.data)
genecounts2 <- as.matrix(dxl01_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/raw_counts_dxl01_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/raw_counts_dxl01_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/tpm_dxl01_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/tpm_dxl01_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_rep2_tpm.csv")
...
mir31hg_reg <- mir31hg_reg + annotate(geom="text", x=3.5, y=.5, label = as.call(eqs$eq_dmrta1))
mir31hg_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl01/dxl01_smc_qc_counts.csv")
