...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/qc_plots"
...
barcode_key <- read.csv("raw_data_now_on_helium/raw_data/dxl02_key.csv")
...
genecounts1 <- as.matrix(dxl02_1_cfb.data)
genecounts2 <- as.matrix(dxl02_2_cfb.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/raw_counts_dxl02_cfb1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/raw_counts_dxl02_cfb2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/tpm_dxl02_cfb1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/tpm_dxl02_cfb2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_rep2_tpm.csv")
...
anril_reg <- anril_reg + annotate(geom="text", x=45, y=21, label = as.call(eqs$eq_anril))
anril_reg
...
mtap_reg <- mtap_reg + annotate(geom="text", x=25, y=7, label = as.call(eqs$eq_mtap))
mtap_reg
...
cdkn2a_reg <- cdkn2a_reg + annotate(geom="text", x=350, y=62, label = as.call(eqs$eq_cdkn2a))
cdkn2a_reg
...
dmrta1_reg <- dmrta1_reg + annotate(geom="text", x=3, y=.5, label = as.call(eqs$eq_dmrta1))
dmrta1_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl02/dxl02_cfb_qc_counts.csv")
...
count_scatter <- count_scatter + annotate(geom="text", x=1000000, y=220000, label = as.call(counts_eq))
count_scatter
