...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/qc_plots"
...
genecounts1 <- as.matrix(dxl03_1_smc.data)
genecounts2 <- as.matrix(dxl03_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/raw_counts_dxl03_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/raw_counts_dxl03_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/tpm_dxl03_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/tpm_dxl03_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_rep2_tpm.csv")
...
anril_reg <- anril_reg + annotate(geom="text", x=80, y=25, label = as.call(eqs$eq_anril))
anril_reg
...
mtap_reg <- mtap_reg + annotate(geom="text", x=18, y=6, label = as.call(eqs$eq_mtap))
mtap_reg
...
cdkn2b_reg <- cdkn2b_reg + annotate(geom="text", x=3, y=0.5, label = as.call(eqs$eq_cdkn2b))
cdkn2b_reg
...
cdkn2a_reg <- cdkn2a_reg + annotate(geom="text", x=300, y=260, label = as.call(eqs$eq_cdkn2a))
cdkn2a_reg
...
dmrta1_reg <- dmrta1_reg + annotate(geom="text", x=1.5, y=.2, label = as.call(eqs$eq_dmrta1))
dmrta1_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl03/dxl03_smc_qc_counts.csv")
...
count_scatter <- count_scatter + annotate(geom="text", x=1000000, y=750000, label = as.call(counts_eq))
count_scatter
