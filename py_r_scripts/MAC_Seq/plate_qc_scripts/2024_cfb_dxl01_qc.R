...
#save_path = "output/cfb_dxl01"
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/qc_plots"
...
barcode_key <- read.csv("raw_data_now_on_helium/raw_data/dxl01_key.csv")
...
genecounts1 <- as.matrix(dxl01_1_cfb.data)
genecounts2 <- as.matrix(dxl01_2_cfb.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/raw_counts_dxl01_cfb1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/raw_counts_dxl01_cfb2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/tpm_dxl01_cfb1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/tpm_dxl01_cfb2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_rep2_tpm.csv")
...
#write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/cfb_dxl01/dxl01_cfb_qc_counts.csv")
