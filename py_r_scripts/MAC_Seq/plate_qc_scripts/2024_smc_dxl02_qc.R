...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/qc_plots"
...
barcode_key <- read.csv(paste0(platemap_path,"/dxl02_key.csv"))
...
genecounts1 <- as.matrix(dxl02_1_smc.data)
genecounts2 <- as.matrix(dxl02_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/raw_counts_dxl02_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/raw_counts_dxl02_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/tpm_dxl02_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/tpm_dxl02_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_rep2_tpm.csv")
...
mtap_reg <- mtap_reg + annotate(geom="text", x=30, y=16, label = as.call(eqs$eq_mtap))
mtap_reg
...
cdkn2a_reg <- cdkn2a_reg + annotate(geom="text", x=345, y=355, label = as.call(eqs$eq_cdkn2a))
cdkn2a_reg
...
dmrta1_reg <- dmrta1_reg + annotate(geom="text", x=2.5, y=.5, label = as.call(eqs$eq_dmrta1))
dmrta1_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl02/dxl02_smc_qc_counts.csv")
