...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/qc_plots"
...
genecounts1 <- as.matrix(dxk98_1_smc.data)
genecounts2 <- as.matrix(dxk98_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/raw_counts_dxk98_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/raw_counts_dxk98_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/tpm_dxk98_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/tpm_dxk98_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_rep2_tpm.csv")
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxk98/dxk98_smc_qc_counts.csv")
