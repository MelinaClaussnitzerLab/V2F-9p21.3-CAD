...
barcode_key <- read.csv(paste0(platemap_path,"/dxl04_key.csv"))
...
genecounts1 <- as.matrix(dxl04_1_smc.data)
genecounts2 <- as.matrix(dxl04_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/raw_counts_dxl04_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/raw_counts_dxl04_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/tpm_dxl04_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/tpm_dxl04_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_rep2_tpm.csv")
...
anril_reg <- anril_reg + annotate(geom="text", x=22, y=24, label = as.call(eqs$eq_anril))
anril_reg
...
mtap_reg <- mtap_reg + annotate(geom="text", x=20, y=14, label = as.call(eqs$eq_mtap))
mtap_reg
...
cdkn2b_reg <- cdkn2b_reg + annotate(geom="text", x=3.5, y=1.5, label = as.call(eqs$eq_cdkn2b))
cdkn2b_reg
...
cdkn2a_reg <- cdkn2a_reg + annotate(geom="text", x=340, y=275, label = as.call(eqs$eq_cdkn2a))
cdkn2a_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl04/dxl04_smc_qc_counts.csv")
...
count_scatter <- count_scatter + annotate(geom="text", x=1500000, y=750000, label = as.call(counts_eq))
count_scatter
