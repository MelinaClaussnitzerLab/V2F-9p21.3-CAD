...
save_path = "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/qc_plots"
...
barcode_key <- read.csv(paste0(platemap_path,"/dxl05_key.csv"))
...
genecounts1 <- as.matrix(dxl05_1_smc.data)
genecounts2 <- as.matrix(dxl05_2_smc.data)

write.csv(genecounts1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/raw_counts_dxl05_smc1.csv")

write.csv(genecounts2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/raw_counts_dxl05_smc2.csv")
...
write.csv(counts_rep1, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_rep1_raw.csv")
write.csv(counts_rep2, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_rep2_raw.csv")
...
write.csv(genecounts1_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/tpm_dxl05_smc1_all.csv")
write.csv(genecounts2_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/tpm_dxl05_smc2_all.csv")
...
write.csv(counts_tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_platemap_tpm.csv")
write.csv(counts_rep1tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_rep1_tpm.csv")
write.csv(counts_rep2tpm, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_rep2_tpm.csv")
...
cdkn2b_reg <- cdkn2b_reg + annotate(geom="text", x=11, y=2, label = as.call(eqs$eq_cdkn2b))
cdkn2b_reg
...
cdkn2a_reg <- cdkn2a_reg + annotate(geom="text", x=540, y=470, label = as.call(eqs$eq_cdkn2a))
cdkn2a_reg
...
dmrta1_reg <- dmrta1_reg + annotate(geom="text", x=10, y=.5, label = as.call(eqs$eq_dmrta1))
dmrta1_reg
...
write.csv(readcounts, "/Volumes/broad_mcl/members_dir/bschmand/data/mac_seq/smc_dxl05/dxl05_smc_qc_counts.csv")
...
count_scatter <- count_scatter + annotate(geom="text", x=600000, y=555000, label = as.call(counts_eq))
count_scatter
